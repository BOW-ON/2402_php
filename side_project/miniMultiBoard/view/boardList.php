...
<body>
          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <ul class="dropdown-menu dropdown-menu-dark"> <!-- 색상변경 -->
  ...
  <main>
    <div class="card">
      <img src="/view/img/otter_face_end.png" class="card-img-top" alt="수달">
        <div class="card-body">
    ...
    <div class="card">
        <img src="./img/otter_face_end.png" class="card-img-top" alt="수달">
        <div class="card-body">
          <h5 class="card-title">Card title</h5>
          <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
          <button
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="">
          ...
          <div class="modal-body">
            <!-- textarea -->
            <textarea class="form-control" cols="30" rows="10" placeholder="제목을 입력하세요."></textarea>
            <br><br>
